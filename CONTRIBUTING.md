...
[search the issue tracker](https://github.com/fv3rdugo/sca_ravada_hardening/issues)
to see if someone else in the community has already created a ticket.
If it is not, go ahead and [create a new issue](https://github.com/fv3rdugo/sca_ravada_hardening/issues/new)!
...
guidelines so your code gets along with old code. A recurrent problem for newcommers is to submit code automatically cleaned by the editor. Usually, removed end of line spaces or spaces converted to tabs.
Please make sure you don't do that. Run ``git diff`` before commit to see what you are exactly contributing.
...
We use [conventional commits](https://conventionalcommits.org/) format. Each commit must be for a reason, and we should have an [issue](https://github.com/fv3rdugo/sca_ravada_hardening/issues) for that, so we decided to add the issue number in the footer.
...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/fv3rdugo/sca_ravada_hardening/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/fv3rdugo/sca_ravada_hardening/issues/new).
Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample**, an **executable test case** or a step by step guide demonstrating the expected behavior that is not occurring.
...
Finally, go to your Giihub repository and
[create a Pull Request](https://github.com/fv3rdugo/sca_ravada_hardening/pulls)
...
```sh
git remote add upstream hhttps://github.com/fv3rdugo/sca_ravada_hardening.git
git fetch upstream
...
```sh
git remote add upstream git@github.com/fv3rdugo/sca_ravada_hardening.git
git fetch upstream
git checkout main
...
```sh
git remote add upstream https://github.com/fv3rdugo/sca_ravada_hardening
git fetch upstream
```
